...
//Méthode permettant d’enregistrer sur flux fichier toutes les données des couleurs

void Couleur::Save(ofstream& fichier) const 
{
    #ifdef DEBUG
        cout << "Méthode Save de la classe Couleur" << endl;
    #endif
...
//Méthode permettant de charger toutes les données relatives aux couleurs enregistrée sur le flux 
//fichier passé en paramètre

void Couleur::Load(ifstream& fichier) 
{
    #ifdef DEBUG
        cout << "Méthode Load de la classe Couleur" << endl;
    #endif
